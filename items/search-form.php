        ...
        <div class="row">
            <div class="span8">
                <form <?php echo tag_attributes($formAttributes); ?>>
                    <fieldset>
                        <legend style="padding-top:0"><i class="icon-key"></i> Par Mots-clés</legend>
                        ...
                        <div id="search-narrow-by-fields" class="field">
                            ...
                            <button type="button" class="add_search btn"><i class="icon-plus-sign"></i> <?php echo __('Add a Field'); ?></button>
                        </div>
                    </fieldset>

                    <fieldset>
                        <legend><i class="icon-sitemap"></i> Par Collections</legend>
                        <div class="field">
                    ...
                    <fieldset>
                        <legend><i class="icon-question-sign"></i> Par Types</legend>
                        <div class="field">
                    ...
                    <fieldset>
                        <legend id="searchByTag"><i class="icon-tags"></i> Par Tags </legend>
                        <div class="field">
                    ...
                    <div>
                        <input type="submit" class="submit btn btn-success" name="submit_search" id="submit_search_advanced" value="<?php echo __('Search'); ?>" />
                    </div>
                </form>
            </div>
            <div class="span4">
